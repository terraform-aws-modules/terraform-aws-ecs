...
resource "aws_ecs_task_definition" "this" {
  count = local.create_task_definition && !var.ignore_container_definition_changes ? 1 : 0
...
################################################################################
# Ignore Task Definition
################################################################################

resource "aws_ecs_task_definition" "ignore_container_definition" {
  count = local.create_task_definition && var.ignore_container_definition_changes ? 1 : 0
