...
| <a name="input_disable_default_name_postfix"></a> [disable\_default\_name\_postfix](#input\_disable\_default\_name\_postfix) | [DEPRECATED - will be removed in next breaking change] Determines whether to disable the default postfix added to resource names | `bool` | `false` | no |
