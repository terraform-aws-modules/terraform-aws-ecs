...
| [aws_ecs_task_definition.ignore_container_definition](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ecs_task_definition) | resource |
...
| <a name="input_ignore_container_definition_changes"></a> [ignore\_container\_definition\_changes](#input\_ignore\_container\_definition\_changes) | Whether changes to task `container_definitions` changes should be ignored | `bool` | `false` | no |
