...
| <a name="input_explicit_task_exec_secret_arns"></a> [explicit\_task\_exec\_secret\_arns](#input\_explicit\_task\_exec\_secret\_arns) | Change the task\_exec\_secret\_arns behavior to get the list of ARNs from the secrets defined in containers\_definitions | `bool` | `false` | no |
