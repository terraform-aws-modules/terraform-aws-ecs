...
| <a name="input_health_check_path"></a> [health\_check\_path](#input\_health\_check\_path) | Path for health check requests. Defaults to `/health` | `string` | `"/health"` | no |
