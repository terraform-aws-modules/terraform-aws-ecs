module "wrapper" {
  ...
  alarms                   = try(each.value.alarms, var.defaults.alarms, null)
  ...
  deployment_maximum_percent                   = try(each.value.deployment_maximum_percent, var.defaults.deployment_maximum_percent, null)
  deployment_minimum_healthy_percent           = try(each.value.deployment_minimum_healthy_percent, var.defaults.deployment_minimum_healthy_percent, null)
  ...
  inference_accelerator                        = try(each.value.inference_accelerator, var.defaults.inference_accelerator, null)
  ...
  scale                                   = try(each.value.scale, var.defaults.scale, null)
