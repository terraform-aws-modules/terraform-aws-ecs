module "wrapper" {
  ...
  iam_role_assume_role_policy                  = try(each.value.iam_role_assume_role_policy, var.defaults.iam_role_assume_role_policy, null)
  ...
  tasks_iam_role_assume_role_policy       = try(each.value.tasks_iam_role_assume_role_policy, var.defaults.tasks_iam_role_assume_role_policy, null)
