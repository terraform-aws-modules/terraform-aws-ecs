module "wrapper" {
  ...
  execution_iam_role_assume_role_policy        = try(each.value.execution_iam_role_assume_role_policy, var.defaults.execution_iam_role_assume_role_policy, null)
  ...
  task_iam_role_assume_role_policy             = try(each.value.task_iam_role_assume_role_policy, var.defaults.task_iam_role_assume_role_policy, null)
